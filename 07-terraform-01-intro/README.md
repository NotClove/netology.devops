...
Для проекта мы будем использовать:
 ...
 Kubernetes - для оркестрации контейнеризированных приложений
...
Мониторинг Prometheus + Node Exporter + Grafana + Alertmanager
```
...
![terraform version.png](./pics/terraform%20version.png)
