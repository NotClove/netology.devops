...
1. Есть скрипт:
    ...
    * Какое значение будет присвоено переменной c?
      - В текущем виде, нельзя сложить тип данных int и str, поэтому выдаст ошибку "unsupported operand type(s) for +: 'int' and 'str'"
    * Как получить для переменной c значение 12?
      - Как вариант, перевести переменные в str: c = str(a) + b
    * Как получить для переменной c значение 3?
	  - Аналогично, только перевести переменные в int: c = a + int(b)
